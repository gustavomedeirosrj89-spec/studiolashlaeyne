    ...
    <footer className="bg-foreground text-background py-16 md:py-20 px-6">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 text-center md:text-left">
        ...
        <div className="space-y-6">
          <h4 className="font-headline text-xl text-primary">Localização</h4>
        ...
        <div className="space-y-6">
          <h4 className="font-headline text-xl text-primary">Links Rápidos</h4>
          <ul className="space-y-4 text-muted font-light flex flex-col items-center md:items-start">
      ...
      <div className="max-w-7xl mx-auto mt-16 md:mt-20 pt-8 border-t border-muted/10 flex flex-col md:row justify-between items-center gap-4 text-[10px] md:text-xs text-muted/50 uppercase tracking-[0.2em] text-center">
        <p>© 2024 LAEYNE STUDIO LASH. TODOS OS DIREITOS RESERVADOS.</p>
