...
const styles = [
  {
    ...
    fullDescription: "Aplicação individual para um efeito de 'rímel perfeito' e elegância discreta.",
    imageId: "fio-a-fio",
  ...
  },
  {
    ...
    fullDescription: "Fios em formato de Y que proporcionam volume moderado com extrema leveza.",
  ...
  },
  {
    ...
    fullDescription: "Fans artesanais para um olhar com textura aveludada e densidade máxima.",
    imageId: "vol-russo",
              ...
              <DialogContent className="max-w-4xl p-0 overflow-hidden bg-background border-none rounded-[3rem] shadow-2xl">
                <div className="grid grid-cols-1 md:grid-cols-2">
                  ...
                  <div className="p-10 space-y-8 overflow-y-auto max-h-[90vh]">
                    ...
                    <form onSubmit={handleBooking(style.title)} className="space-y-4">
