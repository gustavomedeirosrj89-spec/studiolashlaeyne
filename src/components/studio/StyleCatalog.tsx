...
import { Sparkles, MessageCircle, Clock, ArrowRight, Calendar as CalendarIcon, CheckCircle2 } from "lucide-react"
import {
  Dialog,
  DialogContent,
  DialogHeader,
    ...
    <section className="py-24 px-6 max-w-5xl mx-auto space-y-16">
      ...
      <div className="flex flex-col gap-12 md:gap-20 items-center">
        {filteredStyles.map((style, idx) => {
          ...
          return (
            <Dialog key={style.id} onOpenChange={(open) => { if (!open) setIsSuccess(false) }}>
